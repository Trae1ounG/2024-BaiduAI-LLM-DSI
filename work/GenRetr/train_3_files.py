...
def parse_args():
    ...
    parser.add_argument("--train_file3", type=str, required=True, default=None, help="Train data path3.")
    ...
    parser.add_argument("--ratio3", type=int, required=True, default=None, help="Train data ratio3.")
...
def custom_alternating_dataloader(dataloader1, dataloader2, dataloader3, ratio1, ratio2, ratio3, max_epochs = 1):
    iter1 = iter(dataloader1)
    iter2 = iter(dataloader2)
    iter3 = iter(dataloader3)
...
def run(args):
    ...
    if args.train_file1 and args.train_file2 and args.train_file3:
        ...
        train_ds3, train_data_loader3 = prepare_data_loader(args.train_file3, tokenizer, args, "train")
        alternating_loader = custom_alternating_dataloader(train_data_loader1, train_data_loader2, train_data_loader3, ratio1 = args.ratio1, ratio2 = args.ratio2, ratio3 = args.ratio3, max_epochs = args.epochs)
    else:
        raise ValueError("Both train_file1 and train_file2 and train_file3 must be provided.")
    ...
    if args.do_train:
        ...
        num_training_steps = ceil(args.epochs * len(train_data_loader3) * args.ratio1 / args.ratio3) + ceil(args.epochs * len(train_data_loader3) * args.ratio2 / args.ratio3) + args.epochs * len(train_data_loader3)
